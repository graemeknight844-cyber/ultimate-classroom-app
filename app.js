...
function setActiveTool(tool, activeBtn) {
  ...
  // FIXED: Only remove active highlights from tool buttons that are NOT the undo button
...
// FIXED: Removed inline bake execution loop to prevent recursive infinite stack updates
